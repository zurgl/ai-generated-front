  ...
  return isVisible ? (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      ...
      <div className="flex flex-wrap items-center gap-y-2 gap-x-12">
        <p className="text-xl leading-6 text-gray-900 font-semibold">
        ...
        <a
          ...
          className="flex-none rounded-full bg-black py-1 px-4 text-sm font-semibold dark:text-white text-white shadow-sm hover:bg-gray-700 "
        >
          Email me
        </a>
      </div>
